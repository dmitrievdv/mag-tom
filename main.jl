...
kernel_simp = calc_simple_kernel_matrix(star, geometry, orientation, (-3.5e7, 3.5e7), 1e6, n, 2n)
calc_emission_kernel_matrix!(kernel, star, geometry, orientation, 1e6, (-3.5e7, 3.5e7); n_Rm = 20, n_vz = 20)
